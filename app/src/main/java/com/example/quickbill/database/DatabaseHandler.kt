package com.example.quickbill.database
...
import com.example.quickbill.models.Order
import com.example.quickbill.models.OrderDisplay
import com.example.quickbill.models.Product
import com.example.quickbill.models.User
import java.security.MessageDigest

/**
 * DatabaseHandler manages the local SQLite database for QuickBill.
 */
class DatabaseHandler(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {

    companion object {
        // Database metadata
        private const val DATABASE_NAME = "QuickBill.db"
